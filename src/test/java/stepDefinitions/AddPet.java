...
public class AddPet {
    ...
    @Then("^user gets the id and name and response$")
    public void user_gets_the_id_and_name_and_response() throws Throwable {
    ...
    public void user_get_error_response_code(int acccode) throws Throwable {
